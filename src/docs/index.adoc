...
The +crm-sales-ui+ plugin is a companion plugin to the +crm-sales+ plugin.
It provides a Twitter Bootstrap based user interface for managing leads and sales opportunities.
